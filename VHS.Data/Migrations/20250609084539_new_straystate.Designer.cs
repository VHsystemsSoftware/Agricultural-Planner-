...
namespace VHS.Data.Core.Migrations
{
    ...
    [Migration("20250609084539_new_straystate")]
    partial class new_straystate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VHS.Data.Core.Models.BatchPlanRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VHS.Data.Core.Models.TrayState", b =>
                {
                    ...
                    b.Property<DateTime?>("ArrivedPaternosterDown")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("ArrivedPaternosterUp")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("ArrivedPreGrow")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("ArrivedTransplant")
                        .HasColumnType("datetime2(7)");
                    ...
                    b.Property<DateTime?>("Seeding")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToGrow")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToHarvest")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToPaternosterDown")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToPaternosterUp")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToPreGrow")
                        .HasColumnType("datetime2(7)");

                    b.Property<DateTime?>("TransportToTransplant")
                        .HasColumnType("datetime2(7)");
            ...
            modelBuilder.Entity("VHS.Data.Core.Models.JobTray", b =>
                {
                    ...
                    b.HasOne("VHS.Data.Core.Models.Job", null)
                        .WithMany("Trays")
                        .HasForeignKey("JobId1");

                    b.HasOne("VHS.Data.Core.Models.JobTray", null)
                        .WithMany()
